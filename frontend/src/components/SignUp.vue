<template>
  <div class="login-container">
    <br>
    <img alt="Shopzee Logo" src="../assets/shopzee.jpg" class="logo">
<h2 style="color:black">Create a new account</h2>
    ...
    <b-form-group label="Your Address:" label-for="input-address">
      <b-form-input
        id="input-address"
  ...
  created(){document.title='Register';},
    methods: {
      ...
      onSubmit(event) {
        ...
        let payload = {"name":this.form.name,"email":this.form.email, "password":this.form.password,"address":this.form.address}
        console.log(payload)
        this.signUp(payload)
        .then(() => {
